      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <p className="mt-6 max-w-3xl mx-auto text-lg text-muted-foreground">
            A complete ecosystem designed to elevate your networking. From stunning card designs to powerful analytics, we provide the tools you need to connect and grow.
          </p>
        </motion.div>
      </div>
    </section>
